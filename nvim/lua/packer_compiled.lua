...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/francesco/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["nvim-cmp"] = {
    after = { "friendly-snippets", "cmp-buffer", "cmp_luasnip", "cmp-nvim-lsp", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'neoscroll.nvim', 'indent-o-matic', 'nvim-colorizer.lua', 'Comment.nvim', 'null-ls.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'FixCursorHold.nvim', 'neoscroll.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'null-ls.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
